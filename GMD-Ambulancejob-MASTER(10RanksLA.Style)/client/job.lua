...
function OpenMobileAmbulanceActionsMenu()
	...
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'mobile_ambulance_actions', {
		...
		elements = {
			...
			{label = '<span style="color:green;">🚑EMS im Dienst<span style="color:white;">', value = 'ems_ouvert'},
			{label = '<span style="color:red;">🚒EMS ausser Dienst<span style="color:white;">', value = 'ems_ferme'}
		}
	}, function(data, menu)
		...
		elseif data.current.value == 'citizen_interaction' then
			ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'citizen_interaction', {
				...
				elements = {
					...
					{label = "💞Rechnung - Leichte Behandlung", value = 'fine_menu'},
					{label = "💕Rechnung - Schwere Behandlung", value = 'fine_menubig'}
				}
			}, function(data, menu)
...
function OpenPharmacyMenu()
	...
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'pharmacy', {
		...
		elements = {
			...
			{label = '<span style="color:green;">Vebände<span style="color:white;">', item = 'bandage', type = 'slider', value = 1, min = 1, max = 100},
			{label = '<span style="color:green;">CBD-Öl<span style="color:white;">', item = 'marijuana2', type = 'slider', value = 1, min = 1, max = 100},
